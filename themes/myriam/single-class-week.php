...
<div <?php generate_do_attr( 'content' ); ?>>
	<main <?php generate_do_attr( 'main' ); ?>>
		...
		<?php while ( have_posts() ) : the_post();
			...
			$slides_label = get_post_meta( get_the_ID(), 'hs_slides_label', true ) ?: __( 'Download Slides', 'myriam' );
			$embed_url    = myriam_vimeo_embed_url( $vimeo_url );
		?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'week-page medium-width' ); ?>>
			...
			<nav class="week-nav" aria-label="<?php esc_attr_e( 'Page sections', 'myriam' ); ?>">
				<?php if ( $embed_url ) : ?>
				<a href="#recording" class="week-nav__link"><?php esc_html_e( 'Recording', 'myriam' ); ?></a>
				<?php endif; ?>
				<?php if ( $slides_url ) : ?>
				<a href="#slides" class="week-nav__link"><?php esc_html_e( 'Slides', 'myriam' ); ?></a>
				<?php endif; ?>
			</nav>
			<?php endif; ?>
			...
			<section id="recording" class="week-section week-section--recording">
				<h2 class="week-section__title"><?php esc_html_e( 'Recording', 'myriam' ); ?></h2>
			...
			<section id="slides" class="week-section week-section--slides">
				<h2 class="week-section__title"><?php esc_html_e( 'Slides', 'myriam' ); ?></h2>
